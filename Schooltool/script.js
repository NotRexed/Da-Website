...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // CDN / paths
    const defaultZones = "https://cdn.jsdelivr.net/gh/NotRexed/assets@latest/zone.json";
    const fallbackZones = "https://cdn.jsdelivr.net/gh/NotRexed/assets@latest/zone.json";
